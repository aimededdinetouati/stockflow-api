...
public class PurchaseOrderItem extends AbstractAuditingEntity<Long> implements Serializable, Persistable<Long> {
    ...
    public PurchaseOrderItem quantity(BigDecimal quantity) {
    ...
    public PurchaseOrderItem total(BigDecimal total) {
        this.setTotal(total);
        return this;
    }
    ...
    public PurchaseOrderItem createdBy(String createdBy) {
        this.setCreatedBy(createdBy);
        return this;
    }

    // Inherited createdDate methods
    public PurchaseOrderItem createdDate(Instant createdDate) {
        this.setCreatedDate(createdDate);
        return this;
    }

    // Inherited lastModifiedBy methods
    public PurchaseOrderItem lastModifiedBy(String lastModifiedBy) {
        this.setLastModifiedBy(lastModifiedBy);
        return this;
    }

    // Inherited lastModifiedDate methods
    public PurchaseOrderItem lastModifiedDate(Instant lastModifiedDate) {
    ...
    public PurchaseOrderItem setIsPersisted() {
