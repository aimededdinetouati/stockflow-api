...
public class CartItem extends AbstractAuditingEntity<Long> implements Serializable, Persistable<Long> {
    ...
    public CartItem addedDate(Instant addedDate) {
    ...
    public CartItem setIsPersisted() {
