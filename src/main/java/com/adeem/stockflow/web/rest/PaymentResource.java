...
import com.adeem.stockflow.service.PaymentService;
...
/**
 * REST controller for managing {@link com.adeem.stockflow.domain.Payment}.
 */
@RestController
...
public class PaymentResource {
    ...
    public ResponseEntity<List<PaymentDTO>> getAllPayments(
        ...
        if ("saleorder-is-null".equals(filter)) {
            LOG.debug("REST request to get all Payments where saleOrder is null");
            return new ResponseEntity<>(paymentService.findAllWhereSaleOrderIsNull(), HttpStatus.OK);
        }
