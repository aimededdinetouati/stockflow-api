...
/**
 * REST controller for managing {@link com.adeem.stockflow.domain.Address}.
 */
@RestController
...
public class AddressResource {
    ...
    public ResponseEntity<List<AddressDTO>> getAllAddresses(
        ...
        if ("clientaccount-is-null".equals(filter)) {
            LOG.debug("REST request to get all Addresss where clientAccount is null");
            return new ResponseEntity<>(addressService.findAllWhereClientAccountIsNull(), HttpStatus.OK);
        }

        if ("supplier-is-null".equals(filter)) {
            LOG.debug("REST request to get all Addresss where supplier is null");
            return new ResponseEntity<>(addressService.findAllWhereSupplierIsNull(), HttpStatus.OK);
        }
