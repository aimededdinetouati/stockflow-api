...
import com.adeem.stockflow.service.CartItemService;
...
/**
 * REST controller for managing {@link com.adeem.stockflow.domain.CartItem}.
 */
@RestController
...
public class CartItemResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<CartItemDTO>> getAllCartItems(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
