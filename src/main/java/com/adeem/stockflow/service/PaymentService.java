...
/**
 * Service Implementation for managing {@link com.adeem.stockflow.domain.Payment}.
 */
@Service
@Transactional
public class PaymentService {
    ...
    /**
     *  Get all the payments where SaleOrder is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<PaymentDTO> findAllWhereSaleOrderIsNull() {
        LOG.debug("Request to get all payments where SaleOrder is null");
