...
public class ShipmentTestSamples {
    ...
    public static Shipment getShipmentSample1() {
        return new Shipment().id(1L).reference("reference1").trackingNumber("trackingNumber1").carrier("carrier1").notes("notes1");
    }

    public static Shipment getShipmentSample2() {
        return new Shipment().id(2L).reference("reference2").trackingNumber("trackingNumber2").carrier("carrier2").notes("notes2");
    }
