...
class UserMapperTest {
    ...
    void testUserToUserDTO() {
        ...
        assertThat(convertedUserDto.getAuthorities()).containsExactly(AuthoritiesConstants.USER_ADMIN);
    }
    ...
    void testUserDTOtoUser() {
        ...
        assertThat(convertedUser.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.USER_ADMIN);
    }
    ...
    void userDTOToUserMapWithAuthoritiesStringShouldReturnUserWithAuthorities() {
        ...
        assertThat(convertedUser.getAuthorities().iterator().next().getName()).isEqualTo(AuthoritiesConstants.USER_ADMIN);
    }
