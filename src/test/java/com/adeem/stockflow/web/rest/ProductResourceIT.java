...
class ProductResourceIT {
    ...
    @Test
    @Transactional
    void checkProfitMarginIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
    ...
    @Test
    @Transactional
    void checkMinimumStockLevelIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        product.setMinimumStockLevel(null);
    ...
    @Test
    @Transactional
    void checkIsVisibleToCustomersIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        product.setIsVisibleToCustomers(null);
